...
public class BlockPizza extends Block
{
    ...
    public void setBlockBoundsBasedOnState(IBlockAccess par1IBlockAccess, int par2, int par3, int par4)
    {
        ...
        float f1 = (l) / 8F;
        this.setBlockBounds(f1, 0F, 0F, 1F, 0.125F, 1F);
    }
    ...
    public AxisAlignedBB getCollisionBoundingBoxFromPool(World par1World, int par2, int par3, int par4)
    {
        ...
        float f1 = (l) / 8F;
        return AxisAlignedBB.getAABBPool().getAABB((double)((float)par2 + f1), (double)par3, (double)((float)par4), (double)((float)(par2 + 1)), (double)((float)par3 + 0.125F), (double)((float)(par4 + 1)));
    }
